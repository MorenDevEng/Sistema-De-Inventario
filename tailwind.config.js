  ...
  theme: {
    extend: {
        ...
        animation: {
            ...
            jiggle: 'jiggle 0.3s ease-in-out 0.25s 1',
        ...
        colors: {
                ...
                // Agrega variaciones "soft" y "softer" basadas en tus colores base
                // Estas son tonos más claros para fondos suaves en badges
                'brand': {  // Usando 'primary' como base para "brand"
                  softer: '#dbeafe',  // Azul muy claro (equivalente a un tono soft de primary)
                  soft: '#162456',    // Azul claro (un poco más intenso que softer)
                },
                'neutral': {  // Usando 'secondary' como base para neutrales
                  primary: {
                    soft: '#f1f5f9',  // Gris muy claro basado en secondary
                  },
                  secondary: {
                    medium: '#cbd5e1',  // Gris claro basado en secondary
                  },
                },
                'danger-soft': '#4d0218',  // Rojo muy claro (soft de danger)
                'success-soft': '#002c22',  // Verde muy claro (soft de success)
                'warning-soft': '#441306',  // Amarillo muy claro (soft de warning)
                
                // Colores de texto (fg = foreground) para los badges
                'fg-brand-strong': '#51a2ff',  // Azul oscuro (strong de primary)
                'fg-danger-strong': '#ffa1ad',  // Rojo oscuro (strong de danger)
                'fg-success-strong': '#5ee9b5',  // Verde oscuro (strong de success)
                'fg-warning': '#ffb86a',  // Amarillo oscuro (strong de warning)
                'heading': '#0f172a',  // Gris muy oscuro para texto neutral
            },
    },
  },
  plugins: [],
